namespace BenchMark.RestLibraries.API;

public class APIEndpoint {

    /// Payload from https://swapi.dev/api/films    
    internal static string GetAllFilms()
    {
        return @"{
            ""count"": 6,
            ""next"": null,
    ...
    /// Payload from https://swapi.dev/api/films/1
    internal static string GetFilmById(int id)
    {
        if(id != 1)
            return "";
