...
public class SavePaymentHttpClientTests : IClassFixture<IntegrationTestFixture>
{
    ...
    public SavePaymentHttpClientTests(IntegrationTestFixture fixture)
    {
        _fixture = fixture;
    }

    [Fact]
    public async void SavePaymentHttpClient_ReturnPayment_WhenCurrencyIsNotEqual()
    {
        ...
        var response = await _fixture.RestLibrariesClient.HttpClientPayment(paymentData);
